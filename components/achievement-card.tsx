    ...
    <div className="card-hover relative rounded-xl overflow-hidden">
      <div className="gradient-color-1 p-4 sm:p-6">
        <div className="flex items-start">
          ...
          <div>
            <div className="inline-block px-2 py-1 rounded-full bg-red-800 text-xs font-medium text-white mb-2">
              {year}
            </div>
            <h3 className="text-base sm:text-xl font-bold text-white mb-2">{title}</h3>
            <p className="text-red-100 text-sm sm:text-base">{description}</p>
          </div>
        </div>
      </div>
    </div>
